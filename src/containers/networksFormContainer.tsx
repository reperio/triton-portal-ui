...
import { getAllNetworksByOwnerId, deleteNetwork } from "../actions/networkActions";
...
function mapActionToProps(dispatch: any) {
    return {
        actions: bindActionCreators({getAllNetworksByOwnerId, deleteNetwork}, dispatch)
    };
}

export default connect(mapStateToProps, mapActionToProps)(NetworksContainer);